...
<section class="content-wrapper">
	<div class="content-container container">
		<form class="dark-matter" style="max-width: 400px;font-size: 15px;font-family:楷体; " id="registerForm" action="user_updatePassword.action" method="post" novalidate="novalidate" onsubmit="return checkForm();">
			<h1 align="left" style="font-size: 20px;font-family: 华文行楷;">用户密码-修改
				<span></span>
			</h1>
			...
			<label>
				<span>原始密码 :</span>
				<input type="text" name="pasw" onblur="checkPsw(this)"/>
				<div class="error"><s:actionerror/></div>
				<br/><br/>
			</label>
			<label>
				<span>新&nbsp;密&nbsp;码 :</span>
				<input type="text" name="newPassword" onblur="checkPsw(this)"/>
				<br/><br/>
			</label>
			<label>
				<span>确认密码 :</span>
				<input type="text" name="renewPassword"/><span id="repswspan" onblur="checkRepsw()"></span>
				<div class="error"><s:actionerror/></div>
				<br/><br/>
			</label>
			<label>
